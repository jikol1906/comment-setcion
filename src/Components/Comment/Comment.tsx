...
import CommentBase, { ICommentBase } from "./CommentBase";

interface ICommentProps extends ICommentBase {
  onReplyButtonClicked : () => void
}

const Comment: React.FunctionComponent<ICommentProps> = ({onReplyButtonClicked, ...props}) => {
  return (
    <CommentContainer>
      <CommentBase {...props}>
        <Button
