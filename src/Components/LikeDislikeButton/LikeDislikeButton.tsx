...
const LikeDislikeButton: React.FunctionComponent<ILikeDislikeButtonProps> = (
  ...
  return (
    <div className="bg-verylightgray text-moderateblue rounded-md flex items-center md:flex-col">
      <button className="w-8 h-8 flex justify-center items-center group" aria-label="like">
      ...
      <button className="w-8 h-8 flex justify-center items-center group" aria-label="dislike">
